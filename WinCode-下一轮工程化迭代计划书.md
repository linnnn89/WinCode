...
更新日期：2026-09-09（北京时间）。核对基线：**0.12.5 / main bbc20ff**。状态：**E1/E2 补修与 E3 有界及真实上游验收完成。显式配置的直接 Roslyn 路径已接入现有 MCP，最新端到端 13 场景、核心回归 344/344 通过。默认后端迁移、E4 公共迁移、Code Host 正式打包及干净环境验收尚未完成。变更尚未提交，最新范围与限制见末尾实施记录。**
