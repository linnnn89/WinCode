...
**源码契约：0.15.0；分支 codex/runtime-baseline-and-cleanup，PR #37 检查点 aa6fc7f 的本地增量，更新日期：2026-09-11（北京时间）。N4 私有输出、共享缓存交错和双实例源码编辑已有本地受控验收；当前增量未提交、推送、合并或发布，远端 CI 与实际消费者仍单列待验。**
