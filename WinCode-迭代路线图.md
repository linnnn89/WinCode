...
| 0.9.2 / R2 | 已实现构建/实例/工具契约指纹，准备 PR | 专项 8/8，非交互回归 177 pass、1 skip，独立 stdio 契约与实际正文核对通过；当前 Codex hello 仍为 0.9.0，不冒称已重连 |
| R3–R6 | 按序推进，R4 在独立 worktree 准备 | 未完成版本不得据此宣称已验证 |
