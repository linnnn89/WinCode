...
const expectedCalls: Record<string, { method: string; args: unknown[] }> = {
  workspace_open: { method: 'openWorkspace', args: ['example', { includeTree: undefined, maxOutputChars: undefined }] },
  wincode_workspace_open: { method: 'openWorkspace', args: ['example', { includeTree: undefined, maxOutputChars: undefined }] },
  ...
  wincode_prepare_context: { method: 'prepareContext', args: [{ task: 'Inspect Target', scopeFiles: ['Target.ts'] }] },
  wincode_find_code_symbol: { method: 'findCodeSymbols', args: ['Target', 'class'] },
  wincode_find_references: { method: 'findCodeReferences', args: ['Target', 'Target.ts'] },
  analyze_change_impact: { method: 'analyzeChangeImpact', args: ['Target'] },
  wincode_analyze_change_impact: { method: 'analyzeChangeImpact', args: ['Target'] },
  wincode_diagnose_project: { method: 'diagnoseProject', args: [] },
  wincode_plan_refactoring: { method: 'planRefactoring', args: ['Target', 'Improve reliability'] },
